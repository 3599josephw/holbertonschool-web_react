...
class App extends PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <Notifications listNotifications={listNotifications} handleDisplayDrawer={this.handleDisplayDrawer} handleHideDrawer={this.handleHideDrawer} displayDrawer={this.state.displayDrawer}/>
